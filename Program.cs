...
namespace BaltaDataAccess
{
    class Program
    {
        ...
        static void DeleteCategory(SqlConnection connection)
        {
            ...
            {
                id = new Guid("f2f97bdd-1092-45c0-96a4-02852f4ef258")
            });
        ...
        static void ExecuteProcedure(SqlConnection connection)
        {
            ...
            var pars = new { StudentId = "c695d73d-ce8d-4bc6-8945-6eafa81265f9" };
        ...
        static void ExecuteScalar(SqlConnection connection)
        {
            ...
            category.Url = "netflix";
            category.Description = "Categoria destinada a series e filmes";
            category.Order = 8;
            category.Summary = "legal";
            category.Featured = false;
        ...
        static void Transaction(SqlConnection connection)
        {
            var category = new Category();
            category.Id = Guid.NewGuid();
            category.Title = "Minha categoria que n quero salvar";
            category.Url = "amazon";
            category.Description = "Categoria destinada a serviços do AWS";
            category.Order = 8;
            category.Summary = "AWS Cloud";
